...
const GTSCard = ({ data, activeIndex, setActiveIndex }) => {
  return (
  ...
  <div className="flex flex-col w-full group">
    <div className="relative aspect-4/5 md:aspect-5/4 overflow-hidden bg-gray-200">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-black/10">
        <h2 className="text-[#101828] transition duration-500 group-hover:text-white text-5xl md:text-6xl font-serif opacity-90">
          360 Deg
        </h2>
      </div>
    </div>
    <div className="bg-gray-300 p-2 transition duration-500 group-hover:bg-[#101828]">
      <p className="text-[#101828] text-center text-xl transition duration-500 group-hover:text-white">
        {item.heading}
      </p>
    </div>
  </div>
