...
const PublicPlacesHero = () => {
  return (
    <section
      className="relative w-full h-[80vh] md:h-screen flex items-center justify-center bg-center bg-cover overflow-hidden"
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1508138221679-760a23a2285b?auto=format&fit=crop&w=2000&q=80')",
      }}
    >
      {/* Dark Overlay */}
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl">
        ...
        <p className="text-gray-200 text-lg md:text-2xl font-light tracking-wide max-w-2xl mx-auto leading-relaxed">
          Engaging public spaces that bring communities together through
          innovative design and inclusive architecture.
        </p>
      </div>
    </section>
  );
...
export default PublicPlacesHero;
