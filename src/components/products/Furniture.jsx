...
const furnitureProducts = [
  { id: 1, title: "Wall-Mounted Vanity Unit", type: "Vanity Units", mounting: "Wall-mounted", material: "Lacquered Wood", finish: "White Gloss", dimensions: "120 x 50 x 60 cm", drawers: 3, shelves: 2, price: "$850", sku: "VM-1001", features: ["Soft-close drawers", "Water resistant", "Integrated sink"], images: ["https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&fit=crop"] },
  { id: 2, title: "Floor-Standing Cabinet", type: "Cabinets", mounting: "Floor-standing", material: "Solid Wood", finish: "Matte Oak", dimensions: "80 x 45 x 100 cm", drawers: 2, shelves: 3, price: "$650", sku: "FC-2001", features: ["Durable wood", "Easy assembly", "Adjustable shelves"], images: ["https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800&fit=crop"] },
  { id: 3, title: "Mirror with Integrated Storage", type: "Mirrors", mounting: "Wall-mounted", material: "Lacquered Wood", finish: "Black Matt", dimensions: "100 x 5 x 70 cm", drawers: 0, shelves: 2, price: "$400", sku: "MS-3001", features: ["LED lighting", "Hidden storage", "Anti-fog"], images: ["https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&fit=crop"] },
  { id: 4, title: "Tall Storage Cabinet", type: "Storage Units", mounting: "Floor-standing", material: "Engineered Wood", finish: "Matte Gray", dimensions: "50 x 40 x 180 cm", drawers: 4, shelves: 5, price: "$720", sku: "TS-4001", features: ["Tall design", "Multiple compartments", "Easy access"], images: ["https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800&fit=crop"] },
  { id: 5, title: "Double Vanity Unit", type: "Vanity Units", mounting: "Floor-standing", material: "Marble & Wood", finish: "Carrara Marble", dimensions: "180 x 60 x 90 cm", drawers: 6, shelves: 4, price: "$1,200", sku: "DV-5001", features: ["Double sink", "Marble top", "Ample storage"], images: ["https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&fit=crop"] },
  { id: 6, title: "Bathroom Shelf Set", type: "Accessory Furniture", mounting: "Wall-mounted", material: "Glass & Metal", finish: "Chrome", dimensions: "Various sizes", drawers: 0, shelves: 3, price: "$180", sku: "BS-6001", features: ["Glass shelves", "Chrome frame", "Modern design"], images: ["https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800&fit=crop"] },
  { id: 7, title: "Towel Unit Cabinet", type: "Accessory Furniture", mounting: "Wall-mounted", material: "Metal & Wood", finish: "Brushed Nickel", dimensions: "60 x 20 x 80 cm", drawers: 1, shelves: 2, price: "$320", sku: "TU-7001", features: ["Towel bars", "Heated rail", "Storage space"], images: ["https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&fit=crop"] },
  { id: 8, title: "Medicine Cabinet", type: "Mirrors", mounting: "Wall-mounted", material: "Lacquered Wood", finish: "White Matt", dimensions: "70 x 15 x 50 cm", drawers: 2, shelves: 3, price: "$280", sku: "MC-8001", features: ["Recessed", "Lockable", "Adjustable"], images: ["https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800&fit=crop"] },
];
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <div className="relative w-full h-[50vh] overflow-hidden">
        <img src="https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=1920&fit=crop" alt="Bathroom Furniture" className="w-full h-full object-cover" />
